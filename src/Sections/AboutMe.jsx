      ...
      <div className="flex flex-col lg:flex-row py-10 mt-2 md:mt-12 px-6 md:px-36 items-center md:items-start w-full justify-center">
        ...
        <div className="flex  flex-col items-center justify-center w-full lg:mt-0 mt-10 px-6 md:px-12 text-center ">
          <p className="text-gray-200">
            Hello! I am Aman, a 7th semester (4th year) student at IIIT Gwalior
            currently pursuing my Integrated B.Tech in Information Technology,
            with <span className="font-extrabold text-lightGreen">7.79/10</span>{" "}
            CPI.
          </p>
          <p className="text-gray-400 mt-5">
            I am a MERN Stack and Blockchain Developer and I really enjoy
            learning new things, seeking opportunities, and building products
            that add value. My focus remains on not just acquiring software
            engineering principles to make cool Applications.
          </p>
          <p className="text-gray-400 mt-5">
            I am focused, organized, and a good team player. In my free time, I
            like to binge-watch series and play mobile games.
          </p>
          <a
