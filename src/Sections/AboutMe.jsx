      ...
      <div className="flex flex-col md:flex-row py-10 mt-2 md:mt-12 px-6 md:px-36 items-center md:items-start w-full  justify-center">
        ...
        <div className="flex items-start flex-col justify-center w-11/12 md:w-6/12 md:mt-0 mt-10 px-6 md:px-12">
          ...
          <p className="text-gray-400 mt-5">
            I am a MERN Stack and Blockchain and I really enjoy learning new
            things, seeking opportunities and building products that add value.
            My focus remains on not just aquiring software engineering
            principles to make cool Applications, but at the same time
          </p>
          <p className="text-gray-400 mt-5">
